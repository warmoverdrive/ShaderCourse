Shader "Holistic/Volumetrics/RaymarchCloudsVolume"
{
    Properties
    {
        _Scale ("Scale", Range (0.1, 10.0)) = 2.0
        _StepScale ("Step Scale", Range (0.01, 100.0)) = 1
        _Steps ("Steps", Range(1,500)) = 60
        _MinHeight ("Min Height", Range (-10, 25.0)) = 0
        _MaxHeight ("Max Height", Range (25.0, 100.0)) = 10
        _FadeDist ("Fade Distance", Range (0.0, 10.0)) = 0.5
        _SunDir ("Sun Direction", Vector) = (1,0,0,0)
        _WindX ("Wind Force on X", Range(0,50)) = 5
        _WindY ("Wind Force on Y", Range(0,50)) = 5
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                value *= _Scale;
                value.xy += _Time.x * float2(_WindX, _WindY);
