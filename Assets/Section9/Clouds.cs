...
public class Clouds : MonoBehaviour
{
	...
	public Color LightColor2 = Color.blue;
	...
	Matrix4x4 GetFrustumCorners()
	{
		...
		frustumCorners.SetRow(0, Vector3.Scale(fCorners[1], new Vector3(1, 1, -1))); // vector 3 at end reverses Z direction
	...
	void OnRenderImage(RenderTexture source, RenderTexture destination)
	{
		...
		Material.SetColor("_LightColor1", LightColor1);
		Material.SetColor("_LightColor2", LightColor2);
